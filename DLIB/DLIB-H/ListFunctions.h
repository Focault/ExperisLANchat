 ...
 *
 * @param _element : element to test (pointer to m_data)
 ...
 * @warning (returns NULL if one of the iterators or predicate function are NULL)
 * @warning if _end is before _begin will get into infinte loop
 */
 ...
 * @warning (returns 0 if one of the iterators or predicate function are NULL)
 * @warning if _end is before _begin will get into infinte loop
 */
